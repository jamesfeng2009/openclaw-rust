...
impl UnifiedDeviceManager {
    ...
    pub async fn capture_camera(
        &self,
        id: &str,
    ) -> Result<crate::nodes::CaptureResult, DeviceError> {
        let camera = self
            .get_camera(id)
            .await
    ...
    pub async fn get_location_data(
        &self,
        id: &str,
    ) -> Result<crate::nodes::LocationResult, DeviceError> {
        let location = self
            .get_location(id)
            .await
...
mod tests {
    ...
    async fn test_register_and_get_screen() {
        ...
        manager
            .register_screen("test_screen", ScreenManager::new())
            .await;
    ...
    async fn test_register_and_get_location() {
        ...
        manager
            .register_location("test_loc", LocationManager::new())
            .await;
    ...
    async fn test_list_capabilities() {
        ...
        manager
            ...
            .await;
        manager
            .register_location("loc1", LocationManager::new())
            .await;
    ...
    async fn test_multiple_devices_same_type() {
        ...
        let camera_count = infos
            .iter()
            .filter(|i| i.device_type == DeviceType::Camera)
            .count();
