...
pub trait Ros2Client: Send + Sync {
    ...
    async fn create_publisher(&self, topic: &str, msg_type: &str) -> Ros2Result<Arc<dyn Ros2Topic>>;
    
    async fn create_subscriber(&self, topic: &str, msg_type: &str) -> Ros2Result<Arc<dyn Ros2Topic>>;
    
    async fn create_service(&self, name: &str, srv_type: &str) -> Ros2Result<Arc<dyn Ros2Service>>;
    
    async fn create_action_client(&self, name: &str, action_type: &str) -> Ros2Result<Arc<dyn Ros2Action>>;
}
