...
mod tests {
    ...
    fn test_bm25_search() {
        ...
        let docs = vec![
            ("doc1".to_string(), "Rust is a systems programming language".to_string(), "memory".to_string(), 1000),
            ("doc2".to_string(), "Python is great for data science".to_string(), "memory".to_string(), 2000),
            ("doc3".to_string(), "Rust has excellent memory safety".to_string(), "memory".to_string(), 3000),
        ];
